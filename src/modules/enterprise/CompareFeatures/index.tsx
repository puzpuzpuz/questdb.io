...
const rows: Row[] = [
  {
    title: "Licence",
    values: ["Commercial", "Commercial", "Commercial", "Apache 2.0"],
  },
  {
    title: "Max supported cores",
    values: ["Up to 4", "Up to 16", "Unlimited", "N/A"],
  },
  {
    title: "Data deduplication",
    description:
      "De-duplicate all inserted data. Replaces matching rows with a new version at no performance cost.",
  ...
  },
  {
    ...
    values: ["available", "available", "available", "unavailable"],
  },
  {
  ...
  },
  {
    ...
    values: ["unavailable", "Optional", "available", "unavailable"],
  },
  {
  ...
  },
  {
    ...
    values: ["Up to 8 hours", "Up to 4 hours", "Up to 1 hour", "unavailable"],
  },
  {
    title: "Priority support patches",
    values: ["unavailable", "Optional", "available", "unavailable"],
  },
]
