...
image: /img/blog/shared/og-arduino.webp
---
...
6.5.2. We recommend the [TCP receiver](/docs/reference/api/ilp/overview/)
instead.
...
![Electrical schema showing how the sensor is wired](/img/blog/2020-06-05/sensor.webp)
