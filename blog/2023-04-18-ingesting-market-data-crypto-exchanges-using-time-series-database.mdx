...
[relational database](/glossary/relational-database/). Instead of polling this
data directly, you could opt to leverage CDC patterns to
[stream changes](/glossary/stream-processing/) to QuestDB instead.
...
- **What is an order book?**
  ...
  An order book is a collection of buy and sell orders for a security or
...
- **What are Candlestick charts?**
  ...
  Candlestick charts are a popular form of financial chart uses to show the
