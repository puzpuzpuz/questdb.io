...
[non-relational database](/glossary/non-relational-database/) with a custom data
model. QuestDB supports both schema-agnostic ingestions over InfluxDB line
protocol and a relational data model. Users can leverage both paradigms and
perform SQL JOINs to correlate "schemaless" data with relational data by
timestamp.
...
demonstrate the effects of [high data cardinality](/glossary/high-cardinality/)
