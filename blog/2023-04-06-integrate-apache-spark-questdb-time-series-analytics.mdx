...
tags: [tutorial, big data, time-series, spark, python, market data]
image: /img/blog/2023-04-06/banner.webp
...
<Banner
  ...
  height={500}
  src="/img/blog/2023-04-06/banner.webp"
  width={692}
></Banner>
...
ingestion rate. This means that Spark desperately needs data, a lot of it!
...and QuestDB has it, a match made in heaven.
...
![Daigram showing data exported to Spark as jobs](/img/blog/2023-04-06/spark-diagram.webp)
...
![Spark UI showing one task completed](/img/blog/2023-04-06/ui.webp)
...
![Spark UI showing three tasks completed](/img/blog/2023-04-06/ui-three-tasks.webp)
...
Our ride might seem bumpy, but we finally have everything working. Our new motto
should be "There is a config option for everything!".
