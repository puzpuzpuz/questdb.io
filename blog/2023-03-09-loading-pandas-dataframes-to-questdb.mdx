...
tags: [tutorial, time-series, pandas, python, questdb]
image: "/img/blog/2023-03-09/banner.webp"
...
<Banner
  ...
  height={591}
  src="/img/blog/2023-03-09/banner.webp"
  width={770}
/>
...
![A screenshot of the result of running data_loader.py: an overview of the data loaded](/img/blog/2023-03-09/data-loader-test.webp)
...
![A screenshot of the result of running query_amount.py: an overview of the query result](/img/blog/2023-03-09/query-amount.webp)
