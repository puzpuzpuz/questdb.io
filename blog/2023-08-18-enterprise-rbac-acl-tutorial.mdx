...
> RBAC with QuestDB is available in QuestDB Cloud or QuestDB Enterprise. The
> best way to test RBAC is to
> [create your own Cloud deployment](https://cloud.questdb.com) and check it out
> with your own data. Right now, new sign-ups receive \$200 in free credit. We
